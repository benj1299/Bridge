...
{
	// On place les joueurs correctement et leur assigne leurs bon rôles
	...
	while (1) {
		printf("Entrez une couleur de carte pour l'entame : ");
		Scan(entame_color, 8);
